...
func (m *MongoStore) UpsertProfile(ctx context.Context, p domain.RelationshipProfile) error {
...
func (m *MongoStore) GetProfile(ctx context.Context, userID string) (*domain.RelationshipProfile, error) {
...
func (m *MongoStore) SaveSummary(ctx context.Context, s domain.SessionSummary) error {
...
func (m *MongoStore) GetLatestSummary(ctx context.Context, userID string) (*domain.SessionSummary, error) {
