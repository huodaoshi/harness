...
func NewGetSessionHandler(st domain.Store) app.HandlerFunc {
...
func NewEndSessionHandler(st domain.Store) app.HandlerFunc {
	return func(ctx context.Context, c *app.RequestContext) {
		...
		summary3, err := application.FinalizeSession(ctx, st, req.SessionID, userID)
		if err != nil {
